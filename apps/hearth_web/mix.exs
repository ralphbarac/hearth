defmodule HearthWeb.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind hearth_web", "esbuild hearth_web"],
      "assets.deploy": [
        "tailwind hearth_web --minify",
        "esbuild hearth_web --minify",
        "phx.digest"
      ]
    ]
  end

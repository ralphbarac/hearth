defmodule HearthWeb.UserAuth do
  use HearthWeb, :verified_routes
  ...
  @remember_me_cookie "_hearth_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      HearthWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
